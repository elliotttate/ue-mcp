...
TSharedPtr<FJsonValue> FLevelHandlers::GetActorsByClass(const TSharedPtr<FJsonObject>& Params)
{
	...
	// includeTransform kept as an alias for includeTransforms.
	const bool bIncludeTransforms =
		OptionalBool(Params, TEXT("includeTransforms"), OptionalBool(Params, TEXT("includeTransform"), true));
